...
try
{
  $query = "UPDATE ACME.tbl_propietario SET nuero_cedula='$cedula', primer_nombre='$Nombre', segundo_nombre='$seNombre', apellidos='$Apellidos', direccion='$Dirreccion', telefono='$Telefono', Ciudad='$Ciudad' WHERE idtbl_propietario=".$id.";";
  ...
  if($Resultado!=0||$Resultado!=null){
    header("Location: ../../Propietario/Con_Propietario.php");
    exit();
  }else{
