...
if ($Nombre != "" ){
  try{
    ...
    $sql = "INSERT INTO tbl_propietario(nuero_cedula, primer_nombre, segundo_nombre, apellidos, direccion, telefono, Ciudad) VALUES ('$cedula', '$Nombre', '$seNombre', '$Apellidos', '$Dirreccion', '$Telefono', '$Ciudad');";
    //echo "querry: ".$sql."<br>";
    //exit();
    $Conexion->query($sql);
