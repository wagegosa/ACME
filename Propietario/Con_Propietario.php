...
$Lista = $Propietario->listarPropietario();
        ...
        <div class="col-md-12">
          ...
          <div class="pull-right">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
              <a href="New_Propietario.php" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Propietario Nuevo</a>
            </form>
          </div>
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" name="myTable">
            ...
            <tbody>
              ...
              <td>
                ...
                <a href="Edi_Propietario.php" class="btn btn-primary btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
              </td>
              </tr>
              <?php endforeach ?>
            </tbody>
