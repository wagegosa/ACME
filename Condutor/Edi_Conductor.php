...
$id=8;//$_POST['idtbl_conductor'];

try {
  $query="SELECT * FROM acme.tbl_conductor WHERE idtbl_conductor=".$id.";";
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="page-header"><span class="glyphicons glyphicons-group"></span> PERSONAS</h3>
          <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><a href="Con_Conductor.php">Conductores</a></li>
            <li class="active">Editar Conductor</li>
          </ol>
        </div>
      </div>
      <!-- Formulario -->
      <form method="post" autocomplete="off" id="frm" action="../config/ClassConductor/classConductor_upd.php">
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-8">
              <input type="text" name="direccion" id="direccion" placeholder="Dirección" class="form-control" value="<?=$R['direccion']?>">
              <span class="help-block" id="error"></span>
          </div>
          <div class="col-md-4">
        ...
        <div><br>
          <input type="hidden" name="id" id="id" value="<?= $R['idtbl_conductor']?>">
