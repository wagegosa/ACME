...
<body>
  <div class="container">
    ...
    <!-- Formulario -->
    <form method="post" autocomplete="off" id="frm" action="../config/ClassConductor/classConductor_Ins.php">
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-8">
          <input type="text" name="direccion" id="direccion" placeholder="Dirección" class="form-control" maxlength="20">
          <span class="help-block" id="error"></span>
      </div>
      <div class="col-md-4">
