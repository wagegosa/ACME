...
?>
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="page-header"><span class="glyphicons glyphicons-group"></span> Conductores</h3>
          <ol class="breadcrumb">
          ...
          <div class="pull-right">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
              <a href="New_Conductor.php" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Conductor Nuevo</a>
            </form>
          </div>
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" name="myTable">
            <thead>
              ...
              <tr>
                ...
                <th data-breakpoints="xs sm">No Cedula</th>
            ...
            <tbody>
              ...
              <tr>
              <td><?= $c++; ?></td>
              <td><?= $libro->nuero_cedula; ?></td>
              <td><?= $libro->primer_nombre." ".$libro->segundo_nombre." ".$libro->apellidos; ?></td>
              <td><?= $libro->direccion; ?></td>
              <td><?= $libro->telefono; ?></td>
              <td><?= $libro->Ciudad; ?></td>
              <td>
                <input type="hidden" name="id" id="id" value="<?= $libro->idtbl_conductor;?>">
                <a href="Edi_Conductor.php" class="btn btn-primary btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
              </td>
              </tr>
              <?php endforeach ?>
            </tbody>
